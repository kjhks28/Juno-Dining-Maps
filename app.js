...
document.querySelector("#openNoticeButton").addEventListener("click",()=>document.querySelector("#noticeDialog").showModal());document.querySelector("#closeNoticeButton").addEventListener("click",()=>document.querySelector("#noticeDialog").close());
