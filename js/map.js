...
function createUnavailableController(){ return {renderMarkers(){},focus(){},focusArea(){},moveTo(){},locate(){return Promise.reject(new Error("지도를 사용할 수 없습니다."));}}; }
...
export async function createMapController(){
  try {
    ...
    return {renderMarkers,focus,focusArea,moveTo,locate};
