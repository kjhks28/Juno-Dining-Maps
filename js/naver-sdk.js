...
const SDK_CALLBACK = "__junoNaverMapsReady";
...
export function loadNaverSdk(){
  ...
  sdkPromise=new Promise((resolve,reject)=>{
    ...
    script.src=`https://oapi.map.naver.com/openapi/v3/maps.js?ncpKeyId=${encodeURIComponent(runtimeConfig.naverMapClientId)}&submodules=geocoder&callback=${SDK_CALLBACK}`;
    script.onload=checkReadiness;
    script.onerror=()=>finish(reject,new Error("네이버 지도 SDK 연결에 실패했습니다."));
    window[SDK_CALLBACK]=checkReadiness;
