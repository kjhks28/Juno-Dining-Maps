...
export function loadRestaurants(){
  ...
  catch(error){ console.error("저장 데이터를 불러오지 못했습니다.",error); return seedRestaurants.map(normalizeRestaurant); }
}
export function saveRestaurants(restaurants){
  try { localStorage.setItem(STORAGE_KEY,JSON.stringify(restaurants)); return true; }
